...
# === Data Chest: Raw flat-CSV output for Algorithmic Strategies ===
DATA_CHEST = os.path.join(os.path.dirname(__file__), '..', 'data_chest')

RAW_STOCKS_PATH = os.path.join(DATA_CHEST, 'stocks')
RAW_CRYPTO_PATH = os.path.join(DATA_CHEST, 'crypto')
RAW_FOREX_PATH = os.path.join(DATA_CHEST, 'forex')
RAW_FUTURES_PATH = os.path.join(DATA_CHEST, 'futures')
RAW_INDICES_PATH = os.path.join(DATA_CHEST, 'indices')
RAW_ETFS_PATH = os.path.join(DATA_CHEST, 'etf')
...
# Default output format for pipeline consumers: 'lean' | 'raw' | 'parquet'
DEFAULT_OUTPUT_FORMAT = os.getenv('DEFAULT_OUTPUT_FORMAT', 'raw')
