...
On the computational side, \cite{reisinger2018numerical} and \cite{sirignano2019deep} have explored the use of modern numerical methods for solving high-dimensional HJB equations, though primarily in the context of option pricing rather than market making. Recent advances in reinforcement learning have shown promise for market making applications \cite{tsantekidis2020using, spooner2021reinforcement}, while cryptocurrency-specific high-frequency trading studies have highlighted unique microstructural challenges \cite{hasbrouck2020cryptocurrencies, li2021high}.
...
\For{$n = N_T-1$ down to $0$}
    ...
    \State Configure CUDA grid: $blocksPerGrid = ((N_S + 31) // 32, (N_I + 31) // 32)$
    \State Configure CUDA block: $threadsPerBlock = (32, 32)$
    \State Launch CUDA kernel: $hjb\_kernel\langle\langle blocksPerGrid, threadsPerBlock\rangle\rangle(d\_V, d\_V\_next, d\_S, d\_I, dt, ds, di, params)$
