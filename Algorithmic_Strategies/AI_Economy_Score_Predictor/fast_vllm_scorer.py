...
class VLLMSentimentScorer:
    def __init__(self):
        # Use AWQ quantized version (4-bit, much smaller memory)
    ...
    def setup_model(self):
        ...
        try:
            ...
            print("Using AWQ 4-bit quantized model (fits in ~4GB)")
            ...
            self.llm = LLM(
                ...
                gpu_memory_utilization=0.85,  # Can use more with quantized model
                max_model_len=2048,
                max_num_seqs=128,  # More concurrent with less memory
                trust_remote_code=True,
                dtype="half",  # FP16 for activations
            )
